...
{
  imports = [
    ./hyprland-customizations/waybar.nix
    ./hyprland-customizations/hyprpaper.nix
    ./hyprland-customizations/hypridle.nix
    ./hyprland-customizations/hyprlock.nix
    ./hyprland-customizations/rofi-customization/rofi.nix
    ./hyprland-customizations/wlogout.nix
    ./hyprland-customizations/mako.nix
  ];
  ...
  wayland.windowManager.hyprland = {
    ...
    settings = {
      ...
      exec-once = [
        "mako"
        #"hypridle"
        "sleep 2; $HOME/nixos/modules/home-manager/hyprland-customizations/change_wallpapers.sh"
        "nix-shell $HOME/nixos/modules/home-manager/hyprland-customizations/waybar-mediaplayer/waybar-mediaplayer-shell.nix --run \"$HOME/nixos/modules/home-manager/hyprland-customizations/waybar-mediaplayer/mkstyle && waybar\""
        "nm-applet --indicator"
      ...
      windowrulev2 = [
        ...
        # float kde authentification window
        # "float,class:^(org.kde.polkit-kde-authentication-agent-1)$"


        # Ref https://wiki.hyprland.org/Configuring/Workspace-Rules/
        # "Smart gaps" / "No gaps when only"
        # uncomment all if you wish to use that. + workspace part
      ...
      workspace = [
        # Ref https://wiki.hyprland.org/Configuring/Workspace-Rules/
        # "Smart gaps" / "No gaps when only"
        # uncomment all if you wish to use that. + windowrulev2 part
